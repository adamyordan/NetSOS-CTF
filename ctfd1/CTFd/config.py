...
class Config(object):
    GROUND_NAME = netsos_config.Config.GROUND_NAME
    GROUND_DATABASE_NAME = netsos_config.Config.GROUND_DATABASE_NAME
    ...
    SQLALCHEMY_DATABASE_URI = 'sqlite:///../db/' + GROUND_DATABASE_NAME
