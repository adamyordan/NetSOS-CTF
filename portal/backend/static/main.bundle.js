...
var AppService = (function () {
    function AppService(http) {
        ...
        this.url = {
            ...
            user: '/api/user/',
            contest: '/api/contest',
            participate: '/api/contest/register',
            loginContest: '/api/contest/login',
            contestStanding: '/api/contest/standing',
        };
